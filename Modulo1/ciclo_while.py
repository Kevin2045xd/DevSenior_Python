...
while opcion != 6:
    ...
    if opcion == 1:
        ...
        print("Total hamburguesas:", totalHamburguesas, "Cantidad:", cantidadHamburguesas)
        print("Total pizzas:", totalPizzas, "Cantidad:", cantidadPizzas)
        print("Total ensaladas:", totalEnsaladas, "Cantidad:", cantidadEnsaladas)
        print("Total salchipapas:", totalSalchipapas, "Cantidad:", cantidadSalchipapas)
        print("Total perros calientes:", totalPerrosCalientes, "Cantidad:", cantidadPerrosCalientes)
        break
    else:
